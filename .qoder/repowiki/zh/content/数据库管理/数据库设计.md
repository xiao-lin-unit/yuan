...
## 更新摘要
**变更内容**
- 更新资产表schema，新增计算能力支持字段
- 完善资产表字段定义，包含calculation_type、income_amount、annual_yield_rate
- 新增资产计算逻辑和相关业务服务
...
**更新** 本次更新反映了资产表schema的重大变更，新增了计算能力支持，使系统能够处理复杂的资产收益计算场景。
...
**图表来源**
- [src/database/index.js:1-951](file://src/database/index.js#L1-L951)
...
资产表管理非流动性资产，如房产、车辆、收藏品等，现已增强计算能力支持。

**更新** 资产表新增了计算能力相关字段，支持复杂的收益计算场景。
...
| income_date | TEXT |  | 收益日期 |
| next_income_date | TEXT |  | 下次收益日期 |
| calculation_type | TEXT |  | 计算类型（按金额计算/按年收益率计算） |
...
**章节来源**
- [src/database/index.js:486-507](file://src/database/index.js#L486-L507)
...
**更新** 新增了完整的资产计算能力支持，包括两种计算模式和相关的业务逻辑。
...
**图表来源**
- [src/services/asset/assetService.ts:55-81](file://src/services/asset/assetService.ts#L55-L81)
...
**章节来源**
- [src/services/asset/assetService.ts:1-218](file://src/services/asset/assetService.ts#L1-L218)
- [src/types/asset/asset.ts:1-39](file://src/types/asset/asset.ts#L1-L39)
...
**更新** 本次更新显著增强了系统的资产计算能力，通过新增的calculation_type、income_amount、annual_yield_rate字段，系统现在能够支持复杂的资产收益计算场景，包括按金额计算和按年收益率计算两种模式。这使得系统能够更好地服务于多样化的财务应用场景，为用户提供更全面的资产管理功能。
