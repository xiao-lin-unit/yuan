...
**更新** 导航系统已进行中央化重构，App.vue 中的导航逻辑已迁移到 src/main.ts 的 appNavigateTo 函数中，实现了更统一的导航处理机制。
...
**图表来源**
- [src/App.vue:1-237](file://src/App.vue#L1-L237)
- [src/main.ts:1-155](file://src/main.ts#L1-L155)
...
**更新** 导航流程已中央化：所有导航请求都通过 appNavigateTo 函数处理，实现了统一的导航处理机制。
...
App->>Main : appNavigateTo(key)
Main-->>App : 返回 {key, params}
...
- [src/components/mobile/expense/ExpensePage.vue:4-4](file://src/components/mobile/expense/ExpensePage.vue#L4-L4)
...
- 代码片段路径
  - [组件映射与导出:45-72](file://src/main.ts#L45-L72)
  - [导航处理函数:75-90](file://src/main.ts#L75-L90)
  - [组件属性处理:97-152](file://src/main.ts#L97-L152)
...
- 底部导航点击无响应
  ...
  - **章节来源**
    ...
    - [src/App.vue:68-98](file://src/App.vue#L68-L98)
    - [src/main.ts:45-72](file://src/main.ts#L45-L72)
- **新增** 导航处理异常
  ...
  - **章节来源**
    - [src/main.ts:75-90](file://src/main.ts#L75-L90)
    - [src/main.ts:97-152](file://src/main.ts#L97-L152)
