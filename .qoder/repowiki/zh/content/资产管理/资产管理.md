...
**更新** 本次更新重点反映了应用变更：新增通用资产服务层架构，包括 assetService.ts、fundService.ts、stockService.ts、liabilityService.ts 等完整服务模块，以及新的计算工具类和类型系统扩展。
...
**更新** 新增完整的服务层架构，提供清晰的业务逻辑封装和类型安全。
...
- [fundService.ts:71-164](file://src/services/asset/fundService.ts#L71-L164)
- [stockService.ts:61-149](file://src/services/asset/stockService.ts#L61-L149)
...
**图表来源**
- [AssetManagement.vue:189-200](file://src/components/mobile/asset/AssetManagement.vue#L189-L200)
- [assetService.ts:76-92](file://src/services/asset/assetService.ts#L76-L92)
- [fundService.ts:505-508](file://src/services/asset/fundService.ts#L505-L508)
- [stockService.ts:461-463](file://src/services/asset/stockService.ts#L461-L463)
...
- [assetService.ts:48-71](file://src/services/asset/assetService.ts#L48-L71)
- [assetService.ts:12-43](file://src/services/asset/assetService.ts#L12-L43)
...
- [stockService.ts:61-149](file://src/services/asset/stockService.ts#L61-L149)
- [stockService.ts:22-37](file://src/services/asset/stockService.ts#L22-L37)
...
- [fundService.ts:71-164](file://src/services/asset/fundService.ts#L71-L164)
- [fundService.ts:22-37](file://src/services/asset/fundService.ts#L22-L37)
...
- [fundService.ts:269-394](file://src/services/asset/fundService.ts#L269-L394)
...
```mermaid
graph LR
AM["AssetManagement.vue"] --> AS["assetService.ts"]
...
**图表来源**
- [AssetManagement.vue:90-98](file://src/components/mobile/asset/AssetManagement.vue#L90-L98)
...
**更新** 新增服务层架构带来的性能优化，包括统一的业务逻辑封装和类型安全。
...
## 结论
资产管理模块经过重构，现已具备完整的三层架构：组件层、服务层和数据层。新增的服务层架构提供了清晰的业务逻辑封装、强类型的安全保障和可复用的计算工具。通过可扩展的服务模块与统一的数据层，开发者可在不破坏现有结构的前提下，灵活扩展新资产类型、优化计算策略与增强报表能力。本次更新显著增强了资产管理功能，新增历史资产跟踪切换、优化资产筛选逻辑，并集成了完整的基金卖出功能，为用户提供更全面的资产管理体验。
