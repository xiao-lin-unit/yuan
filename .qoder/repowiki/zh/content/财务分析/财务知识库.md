...
## 更新摘要
**所做更改**
- 更新了组件目录结构信息，从 `mobile/financial/` 重命名为 `mobile/knowledge/`
- 更新了 App.vue 中的导入路径引用
- 更新了项目结构图和相关章节的文件路径
- 修正了所有相关的文件引用和路径说明
...
## 项目结构
项目采用 Vue 3 + TypeScript + Pinia 的移动端应用架构，支持 Electron 打包与 Capacitor 跨平台运行。财务知识库位于移动端知识模块下，通过路由映射进入知识页面。
...
**图表来源**
- [App.vue:43](file://src/App.vue#L43)
- [FinancialKnowledge.vue:107-215](file://src/components/mobile/knowledge/FinancialKnowledge.vue#L107-L215)
...
**章节来源**
- [index.js:21-190](file://src/database/index.js#L21-L190)
- [FinancialKnowledge.vue:228-275](file://src/components/mobile/knowledge/FinancialKnowledge.vue#L228-L275)
...
- [FinancialKnowledge.vue:203-214](file://src/components/mobile/knowledge/FinancialKnowledge.vue#L203-L214)
