...
## 更新摘要
**变更内容**
- 更新组件目录结构：从 `mobile/financial/` 重命名为 `mobile/goal/`
- 更新 import 路径引用，反映新的目录结构
- 更新项目结构图和依赖关系图中的文件路径
- 修正组件映射和导入路径的准确性
...
- 应用入口：App.vue（组件映射）、main.ts（全局导入）
...
- [main.ts:23](file://src/main.ts#L23)
...
**章节来源**
- [FinancialGoal.vue:133-281](file://src/components/mobile/goal/FinancialGoal.vue#L133-L281)
...
- [App.vue:99-100](file://src/App.vue#L99-L100)
- [main.ts:81](file://src/main.ts#L81)
...
**图表来源**
- [App.vue:99-100](file://src/App.vue#L99-L100)
- [FinancialGoal.vue:167-171](file://src/components/mobile/goal/FinancialGoal.vue#L167-L171)
...
**图表来源**
- [FinancialGoal.vue:167-171](file://src/components/mobile/goal/FinancialGoal.vue#L167-L171)
- [FinancialGoal.vue:173-177](file://src/components/mobile/goal/FinancialGoal.vue#L173-L177)
- [FinancialGoal.vue:205-232](file://src/components/mobile/goal/FinancialGoal.vue#L205-L232)

**章节来源**
- [FinancialGoal.vue:11-35](file://src/components/mobile/goal/FinancialGoal.vue#L11-L35)
- [FinancialGoal.vue:37-138](file://src/components/mobile/goal/FinancialGoal.vue#L37-L138)
- [FinancialGoal.vue:167-281](file://src/components/mobile/goal/FinancialGoal.vue#L167-L281)
...
**图表来源**
- [FinancialGoal.vue:136-137](file://src/components/mobile/goal/FinancialGoal.vue#L136-L137)
- [App.vue:100](file://src/App.vue#L100)
- [main.ts:23](file://src/main.ts#L23)
...
**章节来源**
- [FinancialGoal.vue:133-141](file://src/components/mobile/goal/FinancialGoal.vue#L133-L141)
...
### 组件导入问题
- 验证路径正确性：确保导入路径与实际文件位置一致
- 检查文件扩展名：确认.vue文件的正确扩展名
- 验证组件映射：确保App.vue和main.ts中的组件映射正确
...
## 结论
财务目标管理功能通过清晰的分层架构和完善的数据库设计，为用户提供了完整的财务目标设定、跟踪和管理能力。组件目录结构重组后，系统保持了良好的模块化设计，支持后续的功能增强，如目标模板、批量管理、提醒通知等高级特性。
