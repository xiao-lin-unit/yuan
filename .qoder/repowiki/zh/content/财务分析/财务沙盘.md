...
## 项目结构
该应用采用Vue 3 + Vite + Pinia + Element Plus 的移动端前端架构，配合Capacitor与Electron用于跨平台与桌面端分发。财务沙盘位于移动端金融模块下，作为独立页面组件接入整体导航体系。
...
- [FinancialKnowledge.vue:1-275](file://src/components/mobile/financial/FinancialKnowledge.vue#L1-L275)
...
**图示来源**
- [FinancialSandbox.vue:194-269](file://src/components/mobile/financial/FinancialSandbox.vue#L194-L269)
