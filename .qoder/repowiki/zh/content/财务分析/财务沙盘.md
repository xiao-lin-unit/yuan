...
## 更新摘要
**变更内容**
- **关键计算逻辑更新**：暂停状态的资产不再产生被动收入，失业场景计算排除社会安全和住房公积金类型资产
- **被动收入计算优化**：新增资产状态检查，暂停状态资产不计入被动收入
- **失业场景计算改进**：新增社保和公积金类型资产排除逻辑，提高计算准确性
- **影响范围**：约15行计算逻辑变更，主要影响被动收入和失业维持时长推演场景
...
**图示来源**
- [FinancialSandbox.vue:52-66](file://src/components/mobile/sandbox/FinancialSandbox.vue#L52-L66)
- [SandboxSimulationPage.vue:100-112](file://src/components/mobile/sandbox/SandboxSimulationPage.vue#L100-L112)
- [SandboxResultDetail.vue:177-196](file://src/components/mobile/sandbox/SandboxResultDetail.vue#L177-L196)
- [sandboxService.ts:706-729](file://src/services/sandbox/sandboxService.ts#L706-L729)
...
**章节来源**
- [FinancialSandbox.vue:42-50](file://src/components/mobile/sandbox/FinancialSandbox.vue#L42-L50)
- [FinancialSandbox.vue:52-66](file://src/components/mobile/sandbox/FinancialSandbox.vue#L52-L66)
...
**章节来源**
- [SandboxSimulationPage.vue:14-51](file://src/components/mobile/sandbox/SandboxSimulationPage.vue#L14-L51)
- [SandboxSimulationPage.vue:100-112](file://src/components/mobile/sandbox/SandboxSimulationPage.vue#L100-L112)
...
**章节来源**
- [SandboxHistory.vue:10-27](file://src/components/mobile/sandbox/SandboxHistory.vue#L10-L27)
...
**章节来源**
- [SandboxResultDetail.vue:11-91](file://src/components/mobile/sandbox/SandboxResultDetail.vue#L11-L91)
- [SandboxResultDetail.vue:198-226](file://src/components/mobile/sandbox/SandboxResultDetail.vue#L198-L226)
...
**更新** 关键计算逻辑更新：暂停状态的资产不再产生被动收入，失业场景计算排除社会安全和住房公积金类型资产

**章节来源**
- [sandboxService.ts:249-277](file://src/services/sandbox/sandboxService.ts#L249-L277)
...
**章节来源**
- [index.js:780-821](file://src/database/index.js#L780-L821)
- [index.js:843-845](file://src/database/index.js#L843-L845)
...
**章节来源**
- [App.vue:75-192](file://src/App.vue#L75-L192)
- [main.ts:117-182](file://src/main.ts#L117-L182)
...
**图示来源**
- [FinancialSandbox.vue:38](file://src/components/mobile/sandbox/FinancialSandbox.vue#L38)
...
**章节来源**
- [index.js:852-890](file://src/database/index.js#L852-L890)
- [sandboxService.ts:706-729](file://src/services/sandbox/sandboxService.ts#L706-L729)
...
**章节来源**
- [sandboxService.ts:182-247](file://src/services/sandbox/sandboxService.ts#L182-L247)
- [sandboxService.ts:279-704](file://src/services/sandbox/sandboxService.ts#L279-L704)
...
### 关键更新影响
**被动收入计算优化**：暂停状态的资产不再产生被动收入，提高了计算准确性
**失业场景改进**：排除社会安全和住房公积金类型资产，使失业维持时长推演更加贴近实际
...
### 被动收入计算规则
**更新** 被动收入计算规则已更新，包含以下检查条件：
1. 资产状态检查：暂停状态的资产不计入被动收入
2. 资产类型检查：社保和公积金类型资产不计入被动收入
3. 收益计算：仅计算有实际收益的资产

**章节来源**
- [sandboxService.ts:231-237](file://src/services/sandbox/sandboxService.ts#L231-L237)
- [sandboxService.ts:310-317](file://src/services/sandbox/sandboxService.ts#L310-L317)