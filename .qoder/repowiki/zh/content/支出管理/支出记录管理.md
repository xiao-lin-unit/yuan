...
AddExpensePage[AddExpensePage.vue<br/>支出录入页面]
end
subgraph "辅助组件"
...
AccountService[账户服务<br/>余额计算<br/>状态管理]
end
subgraph "数据访问层"
...
ShowAmountError --> End
AmountValid --> |是| CheckBalance["检查账户余额"]
CheckBalance --> BalanceValid{"余额充足?"}
BalanceValid --> |否| ShowBalanceError["显示余额不足"]
...
**图表来源**
- [AddExpensePage.vue:365-482](file://src/components/mobile/expense/AddExpensePage.vue#L365-L482)
...
**图表来源**
- [AddExpensePage.vue:419-482](file://src/components/mobile/expense/AddExpensePage.vue#L419-L482)
