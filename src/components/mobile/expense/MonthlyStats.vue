<template>
  <StatOverview
    :background="image"
    :main="[{ title: '月支出', value: '¥' + expense.toFixed(2), color: '#67c23a' }]"
    :details="[{ title: '月收入', value: '¥' + income.toFixed(2), color: '#f56c6c' }, { title: '本月结余', value: '¥' + balance.toFixed(2), color: balance < 0 ? '#67c23a' : '#f56c6c' }]"
  />
</template>
